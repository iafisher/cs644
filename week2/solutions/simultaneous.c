/**
 * Solution to homework exercise #9
 * https://iafisher.com/cs644/fall2025/week2
 *
 * Run `simultaneous write BUFSZ` in one terminal and `simultaneous read BUFSZ`
 * in another.
 */
...
// Idea: Writer programs writes all 'a's, then all 'b's, then all 'c's, etc. to the file.
// The reader program loops on reading through the file. If it ever reads back a buffer that
// is not all the same character, that means it read a partial write.
